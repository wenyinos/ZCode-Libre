...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like ZCode-Libre to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let ZCode-Libre remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting ZCode-Libre",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen ZCode-Libre.",
  ...
  "startup.global.starting_services": "Starting ZCode-Libre",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "ZCode-Libre will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another ZCode-Libre or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen ZCode-Libre. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen ZCode-Libre to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen ZCode-Libre.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a ZCode-Libre restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into ZCode-Libre",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to ZCode-Libre and try again",
  ...
  "bots.title": "Bots",
  "bots.description": "Connect external chats and webhooks to ZCode-Libre bots.",
  "bots.listTitle": "Bots",
  "bots.addBot": "New bot",
  ...
  "bots.setup.guide.weixin.create.2":
    "ZCode-Libre saves the bot_token returned by iLink automatically; after scanning, send any message to the bot in Weixin to activate the chat.",
  "bots.setup.guide.weixin.create.3":
    "ZCode-Libre uses a built-in iLink client: `/ilink/bot/getupdates` for long polling and `/ilink/bot/sendmessage` for replies.",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook mode does not require a native bot in the third-party product; your integration only needs to POST messages to ZCode-Libre.",
  ...
  "bots.setup.guide.webhook.bind.1":
    "POST a private-message callback to ZCode-Libre's `/api/bots/webhook` endpoint.",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere":
    "Telegram long polling is handled by another ZCode-Libre window.",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to ZCode-Libre",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to ZCode-Libre",
  "login.description": "Configure a model provider to start using ZCode-Libre",
  ...
  "login.oauth.noProviders":
    "Account sign-in is disabled in this build. Use \"Use API key\" to connect a model provider.",
  ...
  "logout.confirm.title": "Disconnect and restart ZCode-Libre?",
  ...
  "titleBar.menu.help.about": "About ZCode-Libre",
  ...
  "updateDialog.goToDownload": "Go to download",
  ...
  "forceUpdate.title": "Update ZCode-Libre to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart ZCode-Libre to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the ZCode-Libre CDN and have download, extract, and checksum tools.",
  ...
  "webRemoteControl.description": "Control ZCode-Libre workspaces through chat bots.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "ZCode-Libre checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.themeMode.zai-dusk": "Dusk (transparent on macOS/Windows)",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the ZCode-Libre terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While ZCode-Libre is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the ZCode-Libre installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "sidebar.settings.theme.zai-dusk": "Dusk theme (transparent on macOS/Windows)",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching ZCode-Libre task lists.",
  ...
  "resourceManager.storage.diskUsage": "ZCode-Libre uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the ZCode-Libre desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZCode-Libre could not verify its Windows secure import component. Reinstall or update ZCode-Libre before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, ZCode-Libre will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.host.activeDescription":
    "ZCode-Libre provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to ZCode-Libre to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into ZCode-Libre",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to ZCode-Libre 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by ZCode-Libre automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in ZCode-Libre.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. ZCode-Libre uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.vendorServices.title": "Privacy & services",
  "settings.vendorServices.description": "These are off by default; turn one on to restore the upstream behaviour. Terminal and local features are unaffected.",
  "settings.vendorServices.feedback": "Feedback",
  "settings.vendorServices.feedback.description": "Allow submitting feedback and log attachments to the vendor service.",
  "settings.vendorServices.conversationShare": "Conversation sharing",
  "settings.vendorServices.conversationShare.description": "Allow uploading a conversation as a remote share link.",
  "settings.vendorServices.codingPlanPurchase": "Plan purchase entry",
  "settings.vendorServices.codingPlanPurchase.description": "Show the upgrade and plan purchase entry points.",
  "settings.vendorServices.restartHint": "Takes effect after restart.",
  "settings.vendorServices.fixedTitle": "Kept off",
  "settings.vendorServices.fixedDescription": "These have no in-app switch and require explicit configuration to enable.",
  "settings.vendorServices.signIn": "Official account sign-in",
  "settings.vendorServices.signIn.description": "Enable with the ZAI_OAUTH_ENABLED or BIGMODEL_OAUTH_ENABLED environment variable.",
  "settings.vendorServices.pluginMarketplace": "Remote plugin marketplace",
  "settings.vendorServices.pluginMarketplace.description": "Bundled plugins still work; the remote catalog is not fetched by default.",
  ...
  "settings.usage.balance.refresh": "Refresh",
  "settings.usage.balance.loadFailed": "Failed to load balances. Please try again later.",
  "settings.usage.balance.queryFailed": "Query failed. Check the key or your network.",
  "settings.usage.balance.usedPercent": "{percent}% used",
  "settings.usage.balance.resetsIn": "resets in {duration}",
  "settings.usage.balance.breakdown": "granted {granted} · topped up {toppedUp}",
  "settings.usage.balance.window.5h": "5-hour window",
  "settings.usage.balance.window.weekly": "Weekly window",
  "settings.usage.balance.window.monthly": "Monthly window",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in ZCode-Libre after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "ZCode-Libre MCP",
  ...
  "sidebar.usage.plan.mcp": "ZCode-Libre MCP",
  "sidebar.usage.plan.zcodeMcp": "ZCode-Libre MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for ZCode-Libre built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into ZCode-Libre. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. ZCode-Libre follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into ZCode-Libre",
  ...
  "settings.plugins.store.subtitle":
    "Extend ZCode-Libre with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into ZCode-Libre and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. ZCode-Libre follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into ZCode-Libre",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into ZCode-Libre. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. ZCode-Libre follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into ZCode-Libre",
  ...
  "settingsSync.action.finish": "Start using ZCode-Libre",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current ZCode-Libre settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to ZCode-Libre",
  ...
  "onboarding.welcome.title": "Welcome to ZCode-Libre",
  "onboarding.welcome.start": "Start ZCode-Libre",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while ZCode-Libre imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "ZCode-Libre will copy {source} to {target}.\nIf the target file already exists, the ZCode-Libre default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask ZCode-Libre anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask ZCode-Libre anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, ZCode-Libre will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want ZCode-Libre to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart ZCode-Libre app and retry, or ask ZCode-Libre to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with ZCode-Libre in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for ZCode-Libre: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with ZCode-Libre in chat and save a new version.",
  ...
  "chat.quota.mcp.quotaExhausted":
    'ZCode-Libre MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No ZCode-Libre MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "ZCode-Libre",
  ...
  "feedback.submit.template.section.copyErrorHeading": "ZCode-Libre Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while ZCode-Libre is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task ZCode-Libre can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "ZCode-Libre Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "ZCode-Libre Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart ZCode-Libre",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart ZCode-Libre to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified ZCode-Libre plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "ZCode-Libre will verify the Computer Use tools against the exact session when your first session starts.",
