...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 ZCode-Libre 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 ZCode-Libre 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 ZCode-Libre 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 ZCode-Libre",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 ZCode-Libre。",
  ...
  "startup.global.starting_services": "正在启动 ZCode-Libre",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 ZCode-Libre。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "startup.global.error.lock_timeout":
    "等待数据库写锁超时。请检查其他 ZCode-Libre 或 CLI 进程是否仍在更新数据，待其完成后点击重试。",
  "startup.global.error.sql_failed":
    "准备过程未完成。请复制诊断信息查看日志，排除问题后手动重试。应用不会自动重试。",
  "startup.global.error.startup_status_timeout":
    "未能收到启动状态。请退出并重新打开 ZCode-Libre；如果仍失败，请提供诊断信息。",
  "startup.global.error.transport_closed":
    "数据准备进程意外退出或连接中断。请退出并重新打开 ZCode-Libre，应用会重新检查迁移记录。",
  "startup.global.error.unsupported_runtime":
    "当前配置的 Agent 不支持独立存储准备。请恢复配套的 Agent 后重新打开 ZCode-Libre。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 ZCode-Libre 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 ZCode-Libre",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 ZCode-Libre 后重试",
  ...
  "bots.title": "机器人",
  "bots.description": "把外部聊天工具和 Webhook 接入 ZCode-Libre 机器人。",
  "bots.listTitle": "机器人",
  "bots.addBot": "新建机器人",
  ...
  "bots.setup.guide.weixin.create.2":
    "ZCode-Libre 会直接保存 iLink 返回的 bot_token；扫码后请在微信里向 Bot 发送任意消息完成会话激活。",
  "bots.setup.guide.weixin.create.3":
    "ZCode-Libre 内置 iLink 客户端，通过 `/ilink/bot/getupdates` 长轮询收消息，通过 `/ilink/bot/sendmessage` 回复。",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook 模式不需要先在第三方平台创建原生机器人；你的系统只需要能向 ZCode-Libre 回调接口发消息。",
  ...
  "bots.setup.guide.webhook.bind.1": "向 ZCode-Libre 的 `/api/bots/webhook` 发送一条私聊消息回调。",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere": "Telegram 长轮询由另一个 ZCode-Libre 窗口处理。",
  ...
  "login.title": "欢迎来到 ZCode-Libre",
  "login.description": "配置模型服务，开始使用 ZCode-Libre",
  "login.oauth.activeProviderHint": "当前已登录提供方：{provider}。新登录会替换当前登录身份。",
  "login.oauth.loadingProviders": "正在加载登录提供方...",
  "login.oauth.noProviders": "本版本不提供账号登录，请改用「使用 API key」接入模型。",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 ZCode-Libre？",
  ...
  "titleBar.menu.help.about": "关于 ZCode-Libre",
  ...
  "updateDialog.goToDownload": "前往下载",
  ...
  "forceUpdate.title": "需要升级 ZCode-Libre 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 ZCode-Libre 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 ZCode-Libre CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "webRemoteControl.description": "通过聊天机器人控制 ZCode-Libre 工作区。",
  ...
  "settings.themeMode.zai-dusk": "紫夜（macOS/Windows 透明）",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 ZCode-Libre 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 ZCode-Libre 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 ZCode-Libre 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "sidebar.settings.theme.zai-dusk": "紫夜主题（macOS/Windows 透明）",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 ZCode-Libre 任务列表。",
  ...
  "settings.personalPlan.title": "个人套餐",
  "resourceManager.storage.summaryTotal": "ZCode-Libre 总占用",
  ...
  "resourceManager.storage.diskUsage": "ZCode-Libre 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 ZCode-Libre 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZCode-Libre 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 ZCode-Libre。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。ZCode-Libre 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 ZCode-Libre 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 ZCode-Libre。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 ZCode-Libre",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 ZCode-Libre 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 ZCode-Libre 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 ZCode-Libre 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。ZCode-Libre 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。ZCode-Libre 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.vendorServices.title": "隐私与服务",
  "settings.vendorServices.description": "这些能力默认关闭，开启后按你的选择生效；终端与本地功能不受影响。",
  "settings.vendorServices.feedback": "问题反馈",
  "settings.vendorServices.feedback.description": "允许在应用内提交反馈与日志附件到厂商服务。",
  "settings.vendorServices.conversationShare": "会话分享",
  "settings.vendorServices.conversationShare.description": "允许把对话打包上传到远端分享链接。",
  "settings.vendorServices.codingPlanPurchase": "套餐购买入口",
  "settings.vendorServices.codingPlanPurchase.description": "显示升级与购买套餐的入口。",
  "settings.vendorServices.restartHint": "重启后生效。",
  "settings.vendorServices.fixedTitle": "保持关闭",
  "settings.vendorServices.fixedDescription": "以下项不提供应用内开关，需要显式配置才能启用。",
  "settings.vendorServices.signIn": "官方账号登录",
  "settings.vendorServices.signIn.description": "需要账号体系时用 ZAI_OAUTH_ENABLED 或 BIGMODEL_OAUTH_ENABLED 环境变量开启。",
  "settings.vendorServices.pluginMarketplace": "插件市场远端源",
  "settings.vendorServices.pluginMarketplace.description": "内置插件不受影响；远端市场清单默认不拉取。",
  "settings.vendorServices.telemetry": "遥测上报",
  "settings.vendorServices.telemetry.description": "需要时用 ZCODE_TELEMETRY_ENABLED=1 开启，仅建议自建部署使用。",
  "settings.vendorServices.off": "关闭",
  "settings.usage.balance.title": "模型额度",
  "settings.usage.balance.description": "额度用你已配置的 API Key 直接查询各厂商，未配置的服务商不显示。",
  "settings.usage.balance.empty": "还没有配置可查询额度的模型服务商。在「模型服务商」里填入 API Key 后即可看到。",
  "settings.usage.balance.refresh": "刷新",
  "settings.usage.balance.loadFailed": "额度加载失败，请稍后重试。",
  "settings.usage.balance.queryFailed": "查询失败，请检查该服务商的密钥或网络。",
  "settings.usage.balance.usedPercent": "已用 {percent}%",
  "settings.usage.balance.resetsIn": "{duration} 后重置",
  "settings.usage.balance.breakdown": "赠送 {granted} · 充值 {toppedUp}",
  "settings.usage.balance.window.5h": "5 小时窗口",
  "settings.usage.balance.window.weekly": "每周窗口",
  "settings.usage.balance.window.monthly": "每月窗口",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 ZCode-Libre 即可继续编码。",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "ZCode-Libre 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 ZCode-Libre。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。ZCode-Libre 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 ZCode-Libre",
  ...
  "settings.plugins.store.subtitle": "用插件为 ZCode-Libre 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 ZCode-Libre，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。ZCode-Libre 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 ZCode-Libre",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 ZCode-Libre。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。ZCode-Libre 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 ZCode-Libre",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 ZCode-Libre 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 ZCode-Libre",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 ZCode-Libre",
  "onboarding.welcome.start": "开始使用 ZCode-Libre",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 ZCode-Libre 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，ZCode-Libre 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 ZCode-Libre 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 ZCode-Libre 提问…",
  ...
  "chat.toolbar.computerUse.tooltip.ready": "电脑操作已就绪 · 直接描述你想让 ZCode-Libre 做的事",
  "chat.toolbar.computerUse.tooltip.permissionRequired": "缺少 macOS 权限，点击完成授权",
  "chat.toolbar.computerUse.tooltip.error":
    "电脑操作启用失败 · 重启 ZCode-Libre 应用后重试，或让 ZCode-Libre 排查日志",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 ZCode-Libre 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 ZCode-Libre 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 ZCode-Libre 修订后另存一版。",
  ...
  "chat.quota.mcp.quotaExhausted": "ZCode-Libre MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 ZCode-Libre MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "ZCode-Libre 报错信息",
  ...
  "offPeak.keepAwakeBanner": "ZCode-Libre 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 ZCode-Libre 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "ZCode-Libre 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "ZCode-Libre 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 ZCode-Libre",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 ZCode-Libre 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 ZCode-Libre 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，ZCode-Libre 会针对该会话精确验证电脑控制工具。",
